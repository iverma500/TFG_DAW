            ...
            <div class="right">
                <div id="titulo">
                    ...
                    <div class="row">
                        <div class="left">
                            <br>
                            <h1 style="color: #38dc38">El juego ha sido comprado con éxito</h1>
                            <br><br>
                            <h1 style="font-size: x-large">El nuevo juego se encuentra disponible en la sección de <b><a href="MisJuegos.php">Mis Juegos</a></b></h1>
                            <br>
                            <h1>¡Disfrutalo!</h1>
                            <br>
                        </div>
