...
$filasNuevas = crearNuevaContrasenna($_REQUEST["identificador"], $_REQUEST["email"],$_REQUEST["contrasenna"],$_REQUEST["nombre"], $_REQUEST["apellidos"]);

//TODO sigo trabajando en este metodo. Es normal que salga un error. No afecta al tema de las sesiones.
enviarMensajeCorreoPassword($_REQUEST["email"],$_REQUEST["nombre"]);
?>
...
<?php if ($filasNuevas == 1) {?>
    <h3 style="color:green;">Contraseña reestablecida con éxito.</h3>
    <br>
